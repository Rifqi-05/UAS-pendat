...
if (selected2 == 'Data') :
    ...
    st.write("Data ini diambil dari situs kaggle.com")
    st.write("Kasus ini adalah tentang sebuah bank (Thera Bank) yang manajemennya ingin mencari cara untuk mengkonversi nasabah obligasinya menjadi nasabah pinjaman pribadi (sambil mempertahankan mereka sebagai deposan). Sebuah kampanye yang dijalankan bank tahun lalu untuk nasabah liabilitas menunjukkan tingkat konversi yang sehat dengan keberhasilan lebih dari 9%. Hal ini mendorong departemen pemasaran ritel untuk merancang kampanye dengan target pemasaran yang lebih baik untuk meningkatkan rasio keberhasilan dengan anggaran minimal.")
    st.write("Data ini meliputi informasi demografis nasabah (usia, pendapatan, dll), hubungan nasabah dengan bank (hipotek, rekening efek, dll), dan tanggapan nasabah terhadap kampanye pinjaman pribadi terakhir (Personal Loan). Di antara 5000 nasabah ini, hanya 480 (= 9,6%) yang menerima pinjaman pribadi yang ditawarkan kepada mereka pada kampanye sebelumnya.")
...
if (selected2 == 'Procecing data') :
    ...
    st.write("Menggunakan Standart Scaler untuk standarisasi fitur")
